...
<head>
    ...
    <title>CairoCravings Desserts Menu</title>
    <link rel="stylesheet" href="menuu.css"> <!-- Linking to the desserts.css file -->
    <script>
...
<body>
    ...
    <!-- Desserts Products Section -->
    <div class="menu">
        <h1>Our Desserts Selection</h1>
        <div class="product-grid">
            <?php
            $sql = "SELECT * FROM products WHERE category = 'dessert'";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<img src='$productImage' alt='$productName' width='626' height='626'>"; // Ensure the image fits 626x626 dimensions
